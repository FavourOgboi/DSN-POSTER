# Convergent Corrosion Activation Energies Across Independent Green Inhibitor Systems: A Unified Machine Learning Study of Mild Steel Under Variable Environmental Conditions
...
This study does **not** simply claim "ML can predict corrosion rate." Its contribution is a layered set of findings, each grounded in formal evidence:
...
2. **Conditional, not universal, environmental dependence** — temperature dominates only in the temperature-varying gravimetric phases; concentration dominates elsewhere; P3 is inconclusive
3. **A quantified methodological warning** — standard CV inflates corrosion-ML performance by 0.5–1.2 R² units when structured replicates are present, applicable beyond this specific study
4. **Transparent boundaries** — the specific regions where models fail (Tafel, basic medium, high temperature) are reported, not hidden behind one global score
5. **A stress-test framework** — P3 demonstrates what happens when the experimental and measurement regime shifts, rather than pretending all three phases are equivalent
